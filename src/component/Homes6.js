...
function App() {
    ...
    return (
        <div className="section-six">
            ...
            <div>
                <button style={{ color: selected === 1 ? "#ffffff" : "#9c9c9c" }}
                    onClick={() => setSelected(1)} className="business-label">Business</button>
                <button style={{ color: selected === 2 ? "#ffffff" : "#9c9c9c" }}
                    onClick={() => setSelected(2)} className="reseacher-label">Researcher</button>
                <hr style={{
                    border: 'none',
                    height: '1px',
                ...
                {selected === 1 ? (
                    <div className="toggled-div">
                        ...
                        <div className="toggle-div2">
                            <p className='div-p'>Buggify Red Team Specialists helped Us to Find Critical Vulnerabilities that Could be exploited in Wild, that’s what helped us keeping Our Customer’s Data Safe</p>
                            <div className='div-icon-name'>
                                <SlSocialFacebook className="div-icon" style={{ color: '#ffffff', fontSize: "30px", backgroundColor: '#3b5998', padding: '5px 5px 0px 5px', borderRadius: '50%' }} />
                                <div className='t-d'>
                        ...
                        <div className="toggle-div3">
                            <p className='div-p'>We Believe there is immense value in having bug bounty program as our Cyber Security Strategy. We Encourage Buggify and Hacker’s Community for playing Important Role to Safe Twitch</p>
                            <div className='div-icon-name'>
