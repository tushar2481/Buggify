    ...
    return (
        <>
            <div className="second-section">
                <h2 className="h font-weight-bold">Focus on Innovation & Reduce Data Breaches</h2>
                <div ><p className="fs-5 second-section-p "> Buggify has fast triage & Less Response time for Security Researchers Enhanced Security Solutions for
                ...
                <div className="bg-div">
                    <div className="section-second-square">
                        ...
                        <div className=" sq sq2">
                            ...
                            <p className="sq-p">Bug Bounty Platform is Open Source Research Program for Security Researchers who finds Loopholes and legally Vulnerability Report to Organization
                                <br /><br />
